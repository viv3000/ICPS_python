...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('MainApp', '0021_alter_attestation_date_and_more'),
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='title',
            field=models.CharField(max_length=255, verbose_name='Буква класса'),
        ),
        migrations.AlterField(
            model_name='schoolclass',
            name='year',
            field=models.IntegerField(verbose_name='Год набора'),
        ),
        migrations.AlterField(
            model_name='student',
            name='fullName',
        ...
        migrations.AlterField(
            model_name='task',
            name='attestation',
            field=models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='MainApp.attestation', verbose_name='Учитель'),
        ),
        migrations.AlterField(
            model_name='task',
            name='maxPoint',
        ...
        migrations.AlterField(
            model_name='taskresult',
            name='task',
            field=models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='MainApp.task', verbose_name='Задание'),
        ),
        migrations.AlterField(
            model_name='teacher',
            name='classes',
            field=models.ManyToManyField(blank=True, null=True, to='MainApp.schoolclass', verbose_name='Классы'),
        ),
        migrations.AlterField(
            model_name='teacher',
            name='fullName',
        ...
        migrations.AlterField(
            model_name='teacher',
            name='subject',
            field=models.ManyToManyField(blank=True, null=True, to='MainApp.subject', verbose_name='Предметы'),
        ),
        migrations.AlterField(
            model_name='teacher',
            name='user',
